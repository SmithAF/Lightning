...
import WebGLCoreQuadList from './WebGLCoreQuadList.js';
import WebGLCoreQuadOperation from './WebGLCoreQuadOperation.js';
import WebGLCoreRenderExecutor from './WebGLCoreRenderExecutor.js';
import CoreRenderState from '../../tree/core/CoreRenderState.js';
...
export default class WebGLRenderer extends Renderer {
  ...
  uploadTextureSource(textureSource, options) {
    ...
    if (options && options.premultiplyAlpha) {
      format.premultiplyAlpha = options.premultiplyAlpha;
    }

    if (options && options.flipBlueRed) {
  ...
  finishRenderState(renderState) {
    ...
    for (let i = 0, n = renderState.quadOperations.length; i < n; i++) {
      ...
      const extra =
        renderState.quadOperations[i].shader.getExtraAttribBytesPerVertex() * 4 * renderState.quadOperations[i].length;
      offset += extra;
      if (extra) {
